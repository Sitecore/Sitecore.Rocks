...
& MSBuild ..\data\RocksTestData.sln /p:DeployOnBuild=true /p:PublishProfile=sc920
...
Remove-Item -r -Force C:\inetpub\wwwroot\rocksTest920.local\App_Data\unicorn\*
Copy-Item -r -Force ..\data\serialized\* C:\inetpub\wwwroot\rocksTest920.local\App_Data\unicorn\
Sync-Unicorn -ControlPanelUrl "https://rockstest920.local/unicorn.aspx" -SharedSecret $secret
