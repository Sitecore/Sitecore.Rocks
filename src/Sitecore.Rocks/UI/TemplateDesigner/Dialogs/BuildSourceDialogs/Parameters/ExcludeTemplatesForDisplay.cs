...
{
    [DataSourceParameter("Exclude Templates For Display (excludetemplatesfordisplay)", 1000)]
    public class ExcludeTemplatesForDisplay : ItemsDataSourceParameterBase
    {
        ...
        {
            return @"excludetemplatesfordisplay";
        }
    }
}
