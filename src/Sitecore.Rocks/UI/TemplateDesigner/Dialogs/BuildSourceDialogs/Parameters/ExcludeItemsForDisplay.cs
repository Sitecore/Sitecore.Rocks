...
{
    [DataSourceParameter("Exclude Items For Display (excludeitemsfordisplay)", 1000)]
    public class ExcludeItemsForDisplay : ItemsDataSourceParameterBase
    {
