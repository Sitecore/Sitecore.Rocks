...
{
    [DataSourceParameter("Include Templates For Display (includetemplatesfordisplay)", 1000)]
    public class IncludeTemplatesForDisplay : ItemsDataSourceParameterBase
    {
        ...
        {
            return @"includetemplatesfordisplay";
        }
    }
}
