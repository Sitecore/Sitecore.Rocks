...
{
    [Export(typeof(BaseDesigner), Priority = 1500, CreationPolicy = CreationPolicy.NonShared)]
    public class RenderingFileDesigner : BaseDesigner
    {
        public RenderingFileDesigner()
        {
