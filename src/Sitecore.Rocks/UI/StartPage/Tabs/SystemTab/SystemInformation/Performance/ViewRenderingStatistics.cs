...
using Sitecore.Rocks.UI.Management.ManagementItems.StatisticsViewers;
...
{
    [Command(Submenu = ToolsSubmenu.Name), StartPageCommand("View presentation rendering statistics", StartPagePerformanceGroup.Name, 4000), Feature(FeatureNames.Management)]
    public class ViewRenderingStatistics : StartPageCommandBase
    {
        public ViewRenderingStatistics()
        {
            Text = "Statistics";
            Group = "Manage";
            SortingValue = 8160;
        ...
        private void Execute([NotNull] Site site)
        {
            ...
            AppHost.Windows.Factory.OpenManagementViewer(site.Name, new SiteManagementContext(site), StatisticsViewer.ItemName);
        }
    }
}
