...
using Sitecore.Rocks.UI.Management.ManagementItems.Indexes;
...
{
    [Command(Submenu = ToolsSubmenu.Name), StartPageCommand("Explore the contents of the indexes", StartPageSearchIndexesGroup.Name, 1500), Feature(FeatureNames.Management)]
    public class ExploreIndexes : StartPageCommandBase
    {
        public ExploreIndexes()
        {
            Text = "Indexes";
            Group = "Manage";
            SortingValue = 8150;
        ...
        private void Execute([NotNull] Site site)
        {
            ...
            AppHost.Windows.Factory.OpenManagementViewer(site.Name, new SiteManagementContext(site), IndexViewer.ItemName);
        }
    }
}
