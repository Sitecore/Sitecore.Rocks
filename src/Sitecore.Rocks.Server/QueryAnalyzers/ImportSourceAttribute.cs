...
namespace Sitecore.Rocks.Server.QueryAnalyzers
{
    ...
    public class ImportSourceAttribute : ExtensibilityAttribute
    {
        public ImportSourceAttribute([NotNull] string word, int tokenType)
        {
        ...
        public override void Initialize([NotNull] Type type)
        {
            ...
            QueryAnalyzerManager.LoadImportSource(type, this);
        }
    }
}
