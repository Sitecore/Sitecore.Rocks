...
{
    public class BuildSitecoreNuGetPackage : BuildPackageBase
    {
        [NotNull]
        public string NuGetPath { get; private set; }

        [NotNull]
        public string Execute([NotNull] string itemList, [NotNull] string fileList, [NotNull] string packageName, [NotNull] string author, [NotNull] string version, [NotNull] string publisher, [NotNull] string license, [NotNull] string comment, [NotNull] string readme, [NotNull] string targetFileFolder, [NotNull] string nugetPath)
        {
        ...
        protected override PackageBuilderBase GetBuilder(string fileName)
        {
            ...
            return new SitecoreNuGetPackageBuilder(fileName, NuGetPath);
        }
    }
}
