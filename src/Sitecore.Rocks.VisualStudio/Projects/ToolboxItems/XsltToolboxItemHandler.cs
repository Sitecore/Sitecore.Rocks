...
{
    [ToolboxItemHandler(".xsl"), ToolboxItemHandler(".xslt")]
    public class XsltToolboxItemHandler : HtmlToolboxItemHandler
    {
        public override void AddToToolbox(ProjectItem projectItem)
        {
            ...
            const string Html = "<sc:xslfile runat=\"server\" path=\"{0}\"{1} />";
